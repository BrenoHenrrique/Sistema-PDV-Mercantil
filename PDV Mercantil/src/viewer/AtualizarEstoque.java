...
public class AtualizarEstoque extends javax.swing.JDialog {
    ...
    public AtualizarEstoque(java.awt.Frame parent, boolean modal, String idProduto, String nomeProduto) {
        super(parent, modal);
        initComponents();
        this.frame = (JFrame) parent;
        id.setText(idProduto);
        nome.setText(nomeProduto);
    }

    private AtualizarEstoque(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        quant.setFont(new java.awt.Font("Segoe UI Symbol", 0, 16)); // NOI18N
        ...
        nome.setFont(new java.awt.Font("Segoe UI Symbol", 0, 16)); // NOI18N
        ...
        botConfirmar.setBackground(new java.awt.Color(21, 106, 12));
        botConfirmar.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        botCancelar.setBackground(new java.awt.Color(141, 22, 22));
        botCancelar.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        botCancelar.setForeground(new java.awt.Color(255, 255, 255));
        botCancelar.setText("Cancelar");
        botCancelar.setContentAreaFilled(false);
        botCancelar.setOpaque(true);
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(41, 41, 41))
                            .addComponent(quant, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(botCancelar, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(nome, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        setSize(new java.awt.Dimension(511, 340));
    ...
    private void botConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botConfirmarActionPerformed
        conexao.conecta();
        conexao.executaSQL("select * from produto where idProduto='" + id.getText() + "'");
        try {
            conexao.rs.first();
            Double quantAtual = conexao.rs.getDouble("quantAtual");
            Double result = quantAtual + Double.parseDouble(quant.getText());
            stmt = conexao.conn.prepareStatement("update produto set quantAtual='" + result + "' where idProduto='" + id.getText() + "'");
            stmt.execute();
            this.dispose();
            Estoque p = (Estoque) frame;
            p.atualizarTabela();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            AtualizarEstoque dialog = new AtualizarEstoque(new javax.swing.JFrame(), true);
